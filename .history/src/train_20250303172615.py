...
PATH = f'./train_myddqn9_{current_month_day}/'
env_name = 'GridWorld-v22'
...
gamma = 0.9  # TODO discount factor 0.9->0.92
'''
折扣因子反映了未来奖励的重要性。
        ...
        while not done:
            ...
            if done or truncated:
                if reward == 500:
                    ...
                    # print(Fore.RED + 'test success!')
                    # print(Style.RESET_ALL + Fore.BLUE +
                    #       Style.BRIGHT + str(episode))
                # else:
                #     with open(filename, "a") as file:
                #         file.write(f"state: {observation_}\n")
                break
            else:
