...
# 是否加入扰动
disturbance = False
PATH = 'D:\\code\\dqn\\train_myddqn9_12_26'  # 请替换为您的保存路径
env_name = 'GridWorld-v21'  # 请替换为您的环境名称
eval_name = '\\Q_eval\\DDQN_q_eval_213'  # 请替换为您的测试名称
target_name = '\\Q_target\\DDQN_Q_target_213'  # 请替换为您的目标名称
ith_sample = '.pth'  # 假设您的样本后缀是这样，请根据实际情况替换
eval_path = PATH + eval_name + ith_sample
# eval_path = "D:\\code\\dqn_1\\train_myddqn_10_29\\Q_eval\\DDQN_q_eval_4999.pth"
# D:\code\dqn-1\train_myddqn_10_29\Q_eval\DDQN_q_eval_4999.pth
target_path = PATH + target_name + ith_sample
# target_path = "D:\\code\dqn_1\\train_myddqn_10_29\\Q_target\\DDQN_Q_target_4999.pth"
...
def main():
    ...
    # # 假设 avg_reward_list 是已经填充了数据的列表

    # # 创建一个新的列表来表示x轴的点，通常使用索引或时间步
    # x_axis = range(len(avg_reward_list))
